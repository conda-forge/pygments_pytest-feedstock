...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pygments_pytest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9384&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pygments_pytest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pygments_pytest` can be installed with:

```
conda install pygments_pytest
```

It is possible to list all of the versions of `pygments_pytest` available on your platform with:
